...
VL_ATTR_COLD void Vlsq___024root___ctor_var_reset(Vlsq___024root* vlSelf) {
    ...
    vlSelf->lsq_tb__DOT__dut__DOT__unnamedblk17__DOT__resolve_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 3753616623145573660ull);
    vlSelf->lsq_tb__DOT__dut__DOT__unnamedblk17__DOT__unnamedblk18__DOT__unnamedblk19__DOT__idx = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 6690360185860152954ull);
    vlSelf->lsq_tb__DOT__dut__DOT__unnamedblk20__DOT__resolve_done = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 2219082033245079169ull);
    vlSelf->lsq_tb__DOT__dut__DOT__unnamedblk20__DOT__unnamedblk21__DOT__unnamedblk22__DOT__idx = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 16181598796257395499ull);
    ...
    vlSelf->lsq_tb__DOT__dut__DOT__unnamedblk25__DOT__unnamedblk26__DOT__idx = VL_SCOPED_RAND_RESET_I(3, __VscopeHash, 12090875161680398154ull);
