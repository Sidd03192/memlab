...
module fpnew_divsqrt_th_64_multi #(
  ...
  logic [0:NUM_INP_REGS][2:0]                                   inp_pipe_rnd_mode_q /*verilator split_var */;
  ...
  logic [TagWidth-1:0] result_tag_q;
  logic result_mask_q;
  logic [AuxWidth-1:0] result_aux_q;
  ...
  logic [0:NUM_OUT_REGS][AuxWidth-1:0]            out_pipe_aux_q;
